...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      css: {
        src: SRC_CSS + 'base.less',
        dest: SRC_CSS + 'base.css'
      }
    },
    watch: {
      // js: {
    ...
    concat: {
      ...
      less: {
        src: [SRC_CSS + 'vendor/bootstrap.less',
              SRC_CSS + 'sprites.less',
              SRC_CSS + 'styles.less',
              SRC_CSS + 'buttons.less',
              SRC_CSS + 'about.less',
              SRC_CSS + 'mediaqueries.less'],
        dest: SRC_CSS + 'base.less'
      },
      
      css: {
        src: [SRC_CSS + '*.css'],
        dest: BUILD_CSS + 'base.css'
      },
  ...
  grunt.registerTask("prepare-less", "concat:less less concat:css");
  ...
  grunt.registerTask("default", "prepare-less clean lint jst requirejs concat:js");
